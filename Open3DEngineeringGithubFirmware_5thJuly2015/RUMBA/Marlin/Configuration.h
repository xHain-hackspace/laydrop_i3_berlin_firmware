...
#define STRING_CONFIG_H_AUTHOR "(m.winkler@laydrop.com, rumba config)" // Who made the changes.
...
#define X_MAX_POS 190 //changed from 205 to 190 to to hardware constraints
#define X_MIN_POS 0
#define Y_MAX_POS 205
#define Y_MIN_POS 0
#define Z_MAX_POS 195 //changed from 200 to 195 to to hardware constraints
#define Z_MIN_POS 0
...
#define EXTRUDER_OFFSET_X {0.0, 39.57} // (in mm) for each extruder, offset of the hotend on the X axis
#define EXTRUDER_OFFSET_Y {0.0, 0.85}  // (in mm) for each extruder, offset of the hotend on the Y axis
